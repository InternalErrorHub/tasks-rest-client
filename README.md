...
OpenAPI definition
- API version: v0
  - Build date: 2024-01-27T21:36:14.285176533Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "net.internalerror:tasks-rest-client:1.0.1-SNAPSHOT"
  }
```
...
* `target/tasks-rest-client-1.0.1-SNAPSHOT.jar`
* `target/lib/*.jar`

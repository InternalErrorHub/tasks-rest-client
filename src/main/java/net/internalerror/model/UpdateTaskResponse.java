...
public class UpdateTaskResponse {
  ...
  **/
  ...
  public UpdateTaskResponse details(String details) {
  ...
  **/
  ...
  public UpdateTaskResponse due(OffsetDateTime due) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateTaskResponse.name) &&
        Objects.equals(this.details, updateTaskResponse.details) &&
        Objects.equals(this.due, updateTaskResponse.due);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTaskResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

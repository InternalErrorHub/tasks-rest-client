...
public class TaskInfo {
  ...
  **/
  ...
  public TaskInfo due(OffsetDateTime due) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, taskInfo.name) &&
        Objects.equals(this.due, taskInfo.due);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaskInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaskInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TaskInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskInfo` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

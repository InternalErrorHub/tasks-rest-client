...
public class CreateTaskResponse {
  ...
  **/
  ...
  public CreateTaskResponse due(OffsetDateTime due) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createTaskResponse.name) &&
        Objects.equals(this.due, createTaskResponse.due);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTaskResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
